...
RhinoArtisan adds some new menus to the Rhino Options window.
...
* **Application**: This allows you to set which 3D printing slicer application installed on your computer you want to use by default to open exported models from RhinoArtisan. You can write the .exe file location of the slicer application using the text box below, or click on the three dots on the right and then select the .exe file.

### Toolbars

### ![](/img/v54/image (94).png>)

#### Files

RhinoArtisan adds the RhinoArtisan toolbar, which allows you to have the tabs from the Ribbon in a separate email, ideal for easy access when using the default Rhino interface.

If you click on the 2Shapes item on this menu, you will see the available toolbars you can activate in the space below.

In addition, you can see the location of the plugin file below the FIles menu.

#### Toolbars

If you have selected RhinoArtisan on the Files menu above, you will see all the available toolbars you can enable on this menu. Checking the box on the left of each toolbar will make it pop up as a standalone toolbar on your interface.
